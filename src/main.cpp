...
// configuration step. It creates a namespace called `blublozuar`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        blublozuar::cmake::project_name,
        blublozuar::cmake::project_version));// version string, acquired
